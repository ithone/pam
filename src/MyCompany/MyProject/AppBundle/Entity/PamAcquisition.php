<?php
	...
	/**
 	* MyCompany\MyProject\AppBundle\Entity\PamAcquisition
 	*
 	* @ORM\Table(name="pam_acquisition")
 	* @ORM\Entity(repositoryClass="MyCompany\MyProject\AppBundle\Repository\PamAcquisitionRepository")
	* */
   	class PamAcquisition
	{	
     	...
     	* @var string $label
     	*
     	* @ORM\Column(name="label", type="string" ,length=60,nullable=false, unique=true)
     	*/
    	private $label;
		/**
     	* @var string $name
