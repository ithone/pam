<?php
	...
	/**
 	* MyCompany\MyProject\AppBundle\Entity\PamAnnee
 	*
 	* @ORM\Table(name="pam_annee")
 	* @ORM\Entity(repositoryClass="MyCompany\MyProject\AppBundle\Repository\PamAnneeRepository")
	* */
   	class PamAnnee
	{	
     	...
     	* @var string $name
     	*
     	* @ORM\Column(name="name", type="string" ,length=4,nullable=false, unique=true)
     	*/
    	private $name;
